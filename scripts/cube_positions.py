...
class Obj_Pos():
    ...
    def get_states(self):
        ...
        # TODO: why do we need to keep the whole loop and all states here? why not just get store the one for the individual object?
        # for a large world with many objects, this could be a slow solution?
