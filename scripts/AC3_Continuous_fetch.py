...
'''
    This file is just a minor mod of the original file of DeepRL-TensorFlow2 A3C continuous.
'''

# system and other imports
import argparse
...
# tensorflow, wandb imports
import wandb    # weights & biases for real-time monitoring
import tensorflow as tf
from tensorflow.keras.layers import Input, Dense, Lambda

# current package imports
import fetch_push  # task environment
import convert_shapes as cs

tf.keras.backend.set_floatx('float64')
wandb.init(name='A3C', project="deep-rl-tf2", entity='lacibacsi')
...
class Actor:
    ...
    def log_pdf(self, mu, std, action):
        ...
        action = cs.change_list_to_tf(action, mu.shape[0], mu.shape[1])
...
class Agent:
    def __init__(self, env_name):
        ...
        self.num_workers = 1
        print("NUMBER OF WORKERS=CPUs available for this training=" +
